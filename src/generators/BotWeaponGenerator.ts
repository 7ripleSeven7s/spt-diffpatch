...
import { GenerationData, Inventory, ModsChances } from "@spt-diffpatch/models/eft/common/tables/IBotType";
...
import { GenerateWeaponResult } from "@spt-diffpatch/models/spt/bots/GenerateWeaponResult";
