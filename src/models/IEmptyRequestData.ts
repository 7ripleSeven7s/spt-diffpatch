...
<head>
	...
	<title>Server/IEmptyRequestData.ts at 3.8.1-DEV - Server - SPT-AKI Development</title>
...
<script>
	...
	window.config = {
		...
		csrfToken: 'G7Eeulf6LaY6aID6Ni9SwDSeg4M6MTcxMzk3Mzc1NzcxMzc3NzY2MQ',
		pageData: {},
...
<script src="/assets/js/webcomponents.js?v=1.21.11"></script>
	...
	<noscript>
		...
		<meta property="og:title" content="Server/IEmptyRequestData.ts at 3.8.1-DEV">
		<meta property="og:url" content="https://dev.sp-tarkov.com//SPT-AKI/Server/src/branch/3.8.1-DEV/project/src/models/eft/common/IEmptyRequestData.ts">
...
<nav id="navbar" aria-label="Navigation Bar">
	...
	<div class="navbar-right ui secondary menu">
			...
			<a class="item" rel="nofollow" href="/user/login?redirect_to=%2fSPT-AKI%2fServer%2fsrc%2fbranch%2f3.8.1-DEV%2fproject%2fsrc%2fmodels%2feft%2fcommon%2fIEmptyRequestData.ts">
...
<div role="main" aria-label="Server/IEmptyRequestData.ts at 3.8.1-DEV" class="page-content repository file list ">
	...
	<img class="ui avatar gt-vm" src="/repo-avatars/661-81e984da30db7c62b13db369993fcb3f" width="32" height="32" alt="SPT-AKI/Server">
				...
				<div class="repo-buttons">
					...
					<form method="post" action="/SPT-AKI/Server/action/watch?redirect_to=%2fSPT-AKI%2fServer%2fsrc%2fbranch%2f3.8.1-DEV%2fproject%2fsrc%2fmodels%2feft%2fcommon%2fIEmptyRequestData.ts">
						<input type="hidden" name="_csrf" value="G7Eeulf6LaY6aID6Ni9SwDSeg4M6MTcxMzk3Mzc1NzcxMzc3NzY2MQ">
						...
						<form method="post" action="/SPT-AKI/Server/action/star?redirect_to=%2fSPT-AKI%2fServer%2fsrc%2fbranch%2f3.8.1-DEV%2fproject%2fsrc%2fmodels%2feft%2fcommon%2fIEmptyRequestData.ts">
							<input type="hidden" name="_csrf" value="G7Eeulf6LaY6aID6Ni9SwDSeg4M6MTcxMzk3Mzc1NzcxMzc3NzY2MQ">
...
<script type="module">
	const data = {
		...
		'branchURLSuffix': '/project\/src\/models\/eft\/common\/IEmptyRequestData.ts',
		'tagURLPrefix': '\/SPT-AKI\/Server/src/tag/',
		'tagURLSuffix': '/project\/src\/models\/eft\/common\/IEmptyRequestData.ts',
		'repoLink': "/SPT-AKI/Server",
		'treePath': "project/src/models/eft/common/IEmptyRequestData.ts",
	...
	<h4 class="file-header ui top attached header gt-df gt-ac gt-sb gt-fw">
		...
		<div class="file-header-right file-actions gt-df gt-ac gt-fw">
				...
				<div class="ui buttons gt-mr-2">
					<a class="ui mini basic button" href="/SPT-AKI/Server/raw/branch/3.8.1-DEV/project/src/models/eft/common/IEmptyRequestData.ts">Raw</a>
					
						<a class="ui mini basic button" href="/SPT-AKI/Server/src/commit/d8504950f26a85a3ba681c6cd8a9abc79a9924d6/project/src/models/eft/common/IEmptyRequestData.ts">Permalink</a>
					
					
						<a class="ui mini basic button" href="/SPT-AKI/Server/blame/branch/3.8.1-DEV/project/src/models/eft/common/IEmptyRequestData.ts">Blame</a>
					
					<a class="ui mini basic button" href="/SPT-AKI/Server/commits/branch/3.8.1-DEV/project/src/models/eft/common/IEmptyRequestData.ts">History</a>
					
				</div>
				<a download href="/SPT-AKI/Server/raw/branch/3.8.1-DEV/project/src/models/eft/common/IEmptyRequestData.ts"><span class="btn-octicon" data-tooltip-content="Download file"><svg viewBox="0 0 16 16" class="svg octicon-download" aria-hidden="true" width="16" height="16"><path d="M2.75 14A1.75 1.75 0 0 1 1 12.25v-2.5a.75.75 0 0 1 1.5 0v2.5c0 .138.112.25.25.25h10.5a.25.25 0 0 0 .25-.25v-2.5a.75.75 0 0 1 1.5 0v2.5A1.75 1.75 0 0 1 13.25 14Z"/><path d="M7.25 7.689V2a.75.75 0 0 1 1.5 0v5.689l1.97-1.969a.749.749 0 1 1 1.06 1.06l-3.25 3.25a.749.749 0 0 1-1.06 0L4.22 6.78a.749.749 0 1 1 1.06-1.06l1.97 1.969Z"/></svg></span></a>
	...
	<div class="ui attached table unstackable segment">
		...
		<div class="file-view code-view">
				...
				<table>
					<tbody>
						...
						<tr>
							...
							<td rel="L1" class="lines-code chroma"><code class="code-inner"><span class="kr">export</span> <span class="kr">interface</span> <span class="nx">IEmptyRequestData</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L3" class="lines-code chroma"><code class="code-inner"><span class="p">}</span>
</code></td>
						</tr>
				...
				<div class="code-line-menu ui vertical pointing menu tippy-target">
					...
					<a class="item view_git_blame" href="/SPT-AKI/Server/blame/commit/d8504950f26a85a3ba681c6cd8a9abc79a9924d6/project/src/models/eft/common/IEmptyRequestData.ts">View Git Blame</a>
					<a class="item copy-line-permalink" data-url="/SPT-AKI/Server/src/commit/d8504950f26a85a3ba681c6cd8a9abc79a9924d6/project/src/models/eft/common/IEmptyRequestData.ts">Copy Permalink</a>
				</div>
