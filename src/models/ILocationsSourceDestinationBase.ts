...
<head>
	...
	<title>Server/ILocationsSourceDestinationBase.ts at 3.8.1-DEV - Server - SPT-AKI Development</title>
...
<script>
	...
	window.config = {
		...
		csrfToken: 'rrOs1PTOZUat2TIpxzD7kf-bg9s6MTcxMzk3Mzc4OTMyNTE2OTI0Mg',
		pageData: {},
...
<script src="/assets/js/webcomponents.js?v=1.21.11"></script>
	...
	<noscript>
		...
		<meta property="og:title" content="Server/ILocationsSourceDestinationBase.ts at 3.8.1-DEV">
		<meta property="og:url" content="https://dev.sp-tarkov.com//SPT-AKI/Server/src/branch/3.8.1-DEV/project/src/models/eft/common/ILocationsSourceDestinationBase.ts">
...
<nav id="navbar" aria-label="Navigation Bar">
	...
	<div class="navbar-right ui secondary menu">
			...
			<a class="item" rel="nofollow" href="/user/login?redirect_to=%2fSPT-AKI%2fServer%2fsrc%2fbranch%2f3.8.1-DEV%2fproject%2fsrc%2fmodels%2feft%2fcommon%2fILocationsSourceDestinationBase.ts">
...
<div role="main" aria-label="Server/ILocationsSourceDestinationBase.ts at 3.8.1-DEV" class="page-content repository file list ">
	...
	<img class="ui avatar gt-vm" src="/repo-avatars/661-81e984da30db7c62b13db369993fcb3f" width="32" height="32" alt="SPT-AKI/Server">
				...
				<div class="repo-buttons">
					...
					<form method="post" action="/SPT-AKI/Server/action/watch?redirect_to=%2fSPT-AKI%2fServer%2fsrc%2fbranch%2f3.8.1-DEV%2fproject%2fsrc%2fmodels%2feft%2fcommon%2fILocationsSourceDestinationBase.ts">
						<input type="hidden" name="_csrf" value="rrOs1PTOZUat2TIpxzD7kf-bg9s6MTcxMzk3Mzc4OTMyNTE2OTI0Mg">
						...
						<form method="post" action="/SPT-AKI/Server/action/star?redirect_to=%2fSPT-AKI%2fServer%2fsrc%2fbranch%2f3.8.1-DEV%2fproject%2fsrc%2fmodels%2feft%2fcommon%2fILocationsSourceDestinationBase.ts">
							<input type="hidden" name="_csrf" value="rrOs1PTOZUat2TIpxzD7kf-bg9s6MTcxMzk3Mzc4OTMyNTE2OTI0Mg">
...
<script type="module">
	const data = {
		...
		'branchURLSuffix': '/project\/src\/models\/eft\/common\/ILocationsSourceDestinationBase.ts',
		'tagURLPrefix': '\/SPT-AKI\/Server/src/tag/',
		'tagURLSuffix': '/project\/src\/models\/eft\/common\/ILocationsSourceDestinationBase.ts',
		'repoLink': "/SPT-AKI/Server",
		'treePath': "project/src/models/eft/common/ILocationsSourceDestinationBase.ts",
...
<div class="js-branch-tag-selector gt-mr-2">
	...
	<h4 class="file-header ui top attached header gt-df gt-ac gt-sb gt-fw">
		...
		<div class="file-header-right file-actions gt-df gt-ac gt-fw">
				...
				<div class="ui buttons gt-mr-2">
					<a class="ui mini basic button" href="/SPT-AKI/Server/raw/branch/3.8.1-DEV/project/src/models/eft/common/ILocationsSourceDestinationBase.ts">Raw</a>
					
						<a class="ui mini basic button" href="/SPT-AKI/Server/src/commit/d8504950f26a85a3ba681c6cd8a9abc79a9924d6/project/src/models/eft/common/ILocationsSourceDestinationBase.ts">Permalink</a>
					
					
						<a class="ui mini basic button" href="/SPT-AKI/Server/blame/branch/3.8.1-DEV/project/src/models/eft/common/ILocationsSourceDestinationBase.ts">Blame</a>
					
					<a class="ui mini basic button" href="/SPT-AKI/Server/commits/branch/3.8.1-DEV/project/src/models/eft/common/ILocationsSourceDestinationBase.ts">History</a>
					
				</div>
				<a download href="/SPT-AKI/Server/raw/branch/3.8.1-DEV/project/src/models/eft/common/ILocationsSourceDestinationBase.ts"><span class="btn-octicon" data-tooltip-content="Download file"><svg viewBox="0 0 16 16" class="svg octicon-download" aria-hidden="true" width="16" height="16"><path d="M2.75 14A1.75 1.75 0 0 1 1 12.25v-2.5a.75.75 0 0 1 1.5 0v2.5c0 .138.112.25.25.25h10.5a.25.25 0 0 0 .25-.25v-2.5a.75.75 0 0 1 1.5 0v2.5A1.75 1.75 0 0 1 13.25 14Z"/><path d="M7.25 7.689V2a.75.75 0 0 1 1.5 0v5.689l1.97-1.969a.749.749 0 1 1 1.06 1.06l-3.25 3.25a.749.749 0 0 1-1.06 0L4.22 6.78a.749.749 0 1 1 1.06-1.06l1.97 1.969Z"/></svg></span></a>
				...
				<a class="btn-octicon" href="/SPT-AKI/Server/rss/branch/3.8.1-DEV/project/src/models/eft/common/ILocationsSourceDestinationBase.ts"><svg viewBox="0 0 16 16" class="svg octicon-rss" aria-hidden="true" width="14" height="14"><path d="M2.002 2.725a.75.75 0 0 1 .797-.699C8.79 2.42 13.58 7.21 13.974 13.201a.75.75 0 0 1-1.497.098 10.502 10.502 0 0 0-9.776-9.776.747.747 0 0 1-.7-.798ZM2.84 7.05h-.002a7.002 7.002 0 0 1 6.113 6.111.75.75 0 0 1-1.49.178 5.503 5.503 0 0 0-4.8-4.8.75.75 0 0 1 .179-1.489ZM2 13a1 1 0 1 1 2 0 1 1 0 0 1-2 0Z"/></svg></a>
	...
	<div class="ui attached table unstackable segment">
		...
		<div class="file-view code-view">
				...
				<table>
					<tbody>
						...
						<tr>
							...
							<td rel="L1" class="lines-code chroma"><code class="code-inner"><span class="kr">import</span> <span class="p">{</span> <span class="nx">ILocations</span> <span class="p">}</span> <span class="kr">from</span> <span class="s2">&#34;@spt-aki/models/spt/server/ILocations&#34;</span><span class="p">;</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L3" class="lines-code chroma"><code class="code-inner"><span class="kr">export</span> <span class="kr">interface</span> <span class="nx">ILocationsGenerateAllResponse</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L5" class="lines-code chroma"><code class="code-inner">    <span class="nx">locations</span>: <span class="kt">ILocations</span><span class="p">;</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L6" class="lines-code chroma"><code class="code-inner">    <span class="nx">paths</span>: <span class="kt">Path</span><span class="p">[</span><span class="p">]</span><span class="p">;</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L9" class="lines-code chroma"><code class="code-inner"><span class="kr">export</span> <span class="kr">interface</span> <span class="nx">Path</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L11" class="lines-code chroma"><code class="code-inner">    <span class="nx">Source</span>: <span class="kt">string</span><span class="p">;</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L12" class="lines-code chroma"><code class="code-inner">    <span class="nx">Destination</span>: <span class="kt">string</span><span class="p">;</span>
</code></td>
						</tr>
				...
				<div class="code-line-menu ui vertical pointing menu tippy-target">
					...
					<a class="item view_git_blame" href="/SPT-AKI/Server/blame/commit/d8504950f26a85a3ba681c6cd8a9abc79a9924d6/project/src/models/eft/common/ILocationsSourceDestinationBase.ts">View Git Blame</a>
					<a class="item copy-line-permalink" data-url="/SPT-AKI/Server/src/commit/d8504950f26a85a3ba681c6cd8a9abc79a9924d6/project/src/models/eft/common/ILocationsSourceDestinationBase.ts">Copy Permalink</a>
				</div>
	...
	<div class="left-links" role="contentinfo" aria-label="About Software">
		<a target="_blank" rel="noopener noreferrer" href="https://about.gitea.com">Powered by Gitea</a>
			...
			Template repo/home: <strong>3ms</strong>
