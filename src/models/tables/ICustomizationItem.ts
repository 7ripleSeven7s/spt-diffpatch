...
<head>
	...
	<title>Server/ICustomizationItem.ts at 3.8.1-DEV - Server - SPT-AKI Development</title>
...
<script src="/assets/js/webcomponents.js?v=1.21.11"></script>
	...
	<noscript>
		...
		<meta property="og:title" content="Server/ICustomizationItem.ts at 3.8.1-DEV">
		<meta property="og:url" content="https://dev.sp-tarkov.com//SPT-AKI/Server/src/branch/3.8.1-DEV/project/src/models/eft/common/tables/ICustomizationItem.ts">
...
<nav id="navbar" aria-label="Navigation Bar">
	...
	<div class="navbar-right ui secondary menu">
			...
			<a class="item" rel="nofollow" href="/user/login?redirect_to=%2fSPT-AKI%2fServer%2fsrc%2fbranch%2f3.8.1-DEV%2fproject%2fsrc%2fmodels%2feft%2fcommon%2ftables%2fICustomizationItem.ts">
...
<div role="main" aria-label="Server/ICustomizationItem.ts at 3.8.1-DEV" class="page-content repository file list ">
	...
	<img class="ui avatar gt-vm" src="/repo-avatars/661-81e984da30db7c62b13db369993fcb3f" width="32" height="32" alt="SPT-AKI/Server">
				...
				<div class="repo-buttons">
					...
					<form method="post" action="/SPT-AKI/Server/action/watch?redirect_to=%2fSPT-AKI%2fServer%2fsrc%2fbranch%2f3.8.1-DEV%2fproject%2fsrc%2fmodels%2feft%2fcommon%2ftables%2fICustomizationItem.ts">
						...
						<form method="post" action="/SPT-AKI/Server/action/star?redirect_to=%2fSPT-AKI%2fServer%2fsrc%2fbranch%2f3.8.1-DEV%2fproject%2fsrc%2fmodels%2feft%2fcommon%2ftables%2fICustomizationItem.ts">
							<input type="hidden" name="_csrf" value="PkW81_wxkbYkxecVki1rGaAEM7A6MTcxMzk3MzcwODQ1NjQxODI0MA">
...
<script type="module">
	const data = {
		...
		'branchURLSuffix': '/project\/src\/models\/eft\/common\/tables\/ICustomizationItem.ts',
		'tagURLPrefix': '\/SPT-AKI\/Server/src/tag/',
		'tagURLSuffix': '/project\/src\/models\/eft\/common\/tables\/ICustomizationItem.ts',
		'repoLink': "/SPT-AKI/Server",
		'treePath': "project/src/models/eft/common/tables/ICustomizationItem.ts",
		...
		<button class="branch-dropdown-button gt-ellipsis ui basic small compact button gt-df gt-m-0">
			...
			<svg viewBox="0 0 16 16" class="dropdown icon svg octicon-triangle-down" aria-hidden="true" width="14" height="14"><path d="m4.427 7.427 3.396 3.396a.25.25 0 0 0 .354 0l3.396-3.396A.25.25 0 0 0 11.396 7H4.604a.25.25 0 0 0-.177.427Z"/></svg>
					...
					<span class="breadcrumb repo-path gt-ml-2">
						<a class="section" href="/SPT-AKI/Server/src/branch/3.8.1-DEV" title="Server">Server</a><span class="breadcrumb-divider">/</span><span class="section"><a href="/SPT-AKI/Server/src/branch/3.8.1-DEV/project" title="project">project</a></span><span class="breadcrumb-divider">/</span><span class="section"><a href="/SPT-AKI/Server/src/branch/3.8.1-DEV/project/src" title="src">src</a></span><span class="breadcrumb-divider">/</span><span class="section"><a href="/SPT-AKI/Server/src/branch/3.8.1-DEV/project/src/models" title="models">models</a></span><span class="breadcrumb-divider">/</span><span class="section"><a href="/SPT-AKI/Server/src/branch/3.8.1-DEV/project/src/models/eft" title="eft">eft</a></span><span class="breadcrumb-divider">/</span><span class="section"><a href="/SPT-AKI/Server/src/branch/3.8.1-DEV/project/src/models/eft/common" title="common">common</a></span><span class="breadcrumb-divider">/</span><span class="section"><a href="/SPT-AKI/Server/src/branch/3.8.1-DEV/project/src/models/eft/common/tables" title="tables">tables</a></span><span class="breadcrumb-divider">/</span><span class="active section" title="ICustomizationItem.ts">ICustomizationItem.ts</span></span>
	...
	<h4 class="file-header ui top attached header gt-df gt-ac gt-sb gt-fw">
		...
		<div class="file-header-right file-actions gt-df gt-ac gt-fw">
				...
				<div class="ui buttons gt-mr-2">
					<a class="ui mini basic button" href="/SPT-AKI/Server/raw/branch/3.8.1-DEV/project/src/models/eft/common/tables/ICustomizationItem.ts">Raw</a>
					
						<a class="ui mini basic button" href="/SPT-AKI/Server/src/commit/d8504950f26a85a3ba681c6cd8a9abc79a9924d6/project/src/models/eft/common/tables/ICustomizationItem.ts">Permalink</a>
					
					
						<a class="ui mini basic button" href="/SPT-AKI/Server/blame/branch/3.8.1-DEV/project/src/models/eft/common/tables/ICustomizationItem.ts">Blame</a>
					
					<a class="ui mini basic button" href="/SPT-AKI/Server/commits/branch/3.8.1-DEV/project/src/models/eft/common/tables/ICustomizationItem.ts">History</a>
					
				</div>
				<a download href="/SPT-AKI/Server/raw/branch/3.8.1-DEV/project/src/models/eft/common/tables/ICustomizationItem.ts"><span class="btn-octicon" data-tooltip-content="Download file"><svg viewBox="0 0 16 16" class="svg octicon-download" aria-hidden="true" width="16" height="16"><path d="M2.75 14A1.75 1.75 0 0 1 1 12.25v-2.5a.75.75 0 0 1 1.5 0v2.5c0 .138.112.25.25.25h10.5a.25.25 0 0 0 .25-.25v-2.5a.75.75 0 0 1 1.5 0v2.5A1.75 1.75 0 0 1 13.25 14Z"/><path d="M7.25 7.689V2a.75.75 0 0 1 1.5 0v5.689l1.97-1.969a.749.749 0 1 1 1.06 1.06l-3.25 3.25a.749.749 0 0 1-1.06 0L4.22 6.78a.749.749 0 1 1 1.06-1.06l1.97 1.969Z"/></svg></span></a>
				...
				<a class="btn-octicon" href="/SPT-AKI/Server/rss/branch/3.8.1-DEV/project/src/models/eft/common/tables/ICustomizationItem.ts"><svg viewBox="0 0 16 16" class="svg octicon-rss" aria-hidden="true" width="14" height="14"><path d="M2.002 2.725a.75.75 0 0 1 .797-.699C8.79 2.42 13.58 7.21 13.974 13.201a.75.75 0 0 1-1.497.098 10.502 10.502 0 0 0-9.776-9.776.747.747 0 0 1-.7-.798ZM2.84 7.05h-.002a7.002 7.002 0 0 1 6.113 6.111.75.75 0 0 1-1.49.178 5.503 5.503 0 0 0-4.8-4.8.75.75 0 0 1 .179-1.489ZM2 13a1 1 0 1 1 2 0 1 1 0 0 1-2 0Z"/></svg></a>
	...
	<div class="ui attached table unstackable segment">
		...
		<div class="file-view code-view">
				...
				<table>
					<tbody>
						...
						<tr>
							...
							<td rel="L3" class="lines-code chroma"><code class="code-inner"><span class="kr">export</span> <span class="kr">interface</span> <span class="nx">ICustomizationItem</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L16" class="lines-code chroma"><code class="code-inner">    <span class="nx">ShortName</span>: <span class="kt">string</span><span class="p">;</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L17" class="lines-code chroma"><code class="code-inner">    <span class="nx">Description</span>: <span class="kt">string</span><span class="p">;</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L18" class="lines-code chroma"><code class="code-inner">    <span class="nx">Side</span>: <span class="kt">string</span><span class="p">[</span><span class="p">]</span><span class="p">;</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L19" class="lines-code chroma"><code class="code-inner">    <span class="nx">BodyPart</span>: <span class="kt">string</span><span class="p">;</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L20" class="lines-code chroma"><code class="code-inner">    <span class="nx">AvailableAsDefault?</span>: <span class="kt">boolean</span><span class="p">;</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L21" class="lines-code chroma"><code class="code-inner">    <span class="nx">Body</span>: <span class="kt">string</span><span class="p">;</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L22" class="lines-code chroma"><code class="code-inner">    <span class="nx">Hands</span>: <span class="kt">string</span><span class="p">;</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L23" class="lines-code chroma"><code class="code-inner">    <span class="nx">Feet</span>: <span class="kt">string</span><span class="p">;</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L24" class="lines-code chroma"><code class="code-inner">    <span class="nx">Prefab</span>: <span class="kt">Prefab</span><span class="p">;</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L25" class="lines-code chroma"><code class="code-inner">    <span class="nx">WatchPrefab</span>: <span class="kt">Prefab</span><span class="p">;</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L26" class="lines-code chroma"><code class="code-inner">    <span class="nx">IntegratedArmorVest</span>: <span class="kt">boolean</span><span class="p">;</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L27" class="lines-code chroma"><code class="code-inner">    <span class="nx">WatchPosition</span>: <span class="kt">Ixyz</span><span class="p">;</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L28" class="lines-code chroma"><code class="code-inner">    <span class="nx">WatchRotation</span>: <span class="kt">Ixyz</span><span class="p">;</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L31" class="lines-code chroma"><code class="code-inner"><span class="kr">export</span> <span class="kr">interface</span> <span class="nx">Prefab</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L33" class="lines-code chroma"><code class="code-inner">    <span class="nx">path</span>: <span class="kt">string</span><span class="p">;</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L34" class="lines-code chroma"><code class="code-inner">    <span class="nx">rcid</span>: <span class="kt">string</span><span class="p">;</span>
</code></td>
						</tr>
				...
				<div class="code-line-menu ui vertical pointing menu tippy-target">
					...
					<a class="item view_git_blame" href="/SPT-AKI/Server/blame/commit/d8504950f26a85a3ba681c6cd8a9abc79a9924d6/project/src/models/eft/common/tables/ICustomizationItem.ts">View Git Blame</a>
					<a class="item copy-line-permalink" data-url="/SPT-AKI/Server/src/commit/d8504950f26a85a3ba681c6cd8a9abc79a9924d6/project/src/models/eft/common/tables/ICustomizationItem.ts">Copy Permalink</a>
				</div>
